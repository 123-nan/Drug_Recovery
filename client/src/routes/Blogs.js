...
export default function Blog() {
    ...
    <div className=" blog   px-5">
        ...
        <div className="blogcard mb-5 py-3">
            <h3 className="card-title pt-4 pb-5 text-center blogtitle">Why You Should Have a Support System in Recovery</h3>
            <div className="row">
                <div class="text-center col-md-4 p-4">
                    <img src={image} class="img-fluid rounded-start" style={{height:'220px'}}  alt="..."/>
                </div>
                <div className=" col-md-8 px-5 blogtext">
        ...
        <div className="blogcard my-5 py-3">
            <h3 className="card-title pt-4 pb-5 text-center blogtitle">Long Term Effects of Drug Addiction</h3>
            <div className="row">
                <div class="vtext-center col-md-4 p-4">
                    <img src={img2} class="img-fluid rounded-start" style={{height:'220px'}} alt="..."/>
                </div>
                <div className=" col-md-8 px-5 blogtext">
        ...
        <div className="blogcard my-5 py-3">
            <h3 className="card-title pt-4 pb-5 text-center blogtitle">Why Sober Living Homes Are Important</h3>
            
            <div className="row">
                <div class="text-center col-md-4 p-4">
                    <img src={img3} class="img-fluid rounded-start " style={{height:'220px'}} alt="..."/>
                </div>
                <div className=" col-md-8 px-5 blogtext">
        ...
        <div className="blogcard my-5 py-3">
            <h3 className="card-title pt-4 pb-5 text-center blogtitle">What is post-acute withdrawal syndrome?</h3>
            <div className="row">
                <div class="text-center col-md-4 p-4">
                    <img src={img4} class="img-fluid rounded-start " style={{height:'250px'}} alt="..."/>
                </div>
                <div className=" col-md-8 px-5 blogtext">
        ...
        <div className="blogcard  py-3">
            <h3 className="card-title pt-4 pb-5 mx-5 px-5 text-center blogtitle">Alcohol Addiction</h3>
            
            <div className="row">
                <div class=" text-center col-md-4 p-4">
                    <img src={img5} class="img-fluid rounded-start "  style={{height:'220px'}} alt="..."/>
                </div>
                <div className=" col-md-8 px-5 blogtext">
